  ...
  module Geocoders
    ...
    class OSMGeocoder < Geocoder
      ...
      def self.set_address_components(address_data, loc)
        ...
        loc.city = address_data['county']
        loc.city = address_data['city'] if loc.city.nil? && address_data['city']
        ...
        loc.street_address = "#{address_data['house_number']} #{address_data['road']}".strip if address_data['road']
